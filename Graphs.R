...
# + name="deprecated" tags=["remove_cell"]
...
# + name="graphs walkthrough" tags=["remove_input"]
...
# + name="one month" tags=["remove_cell"] eval=false
...
# + name="all months" tags=["remove_cell"] eval=false
verbose = 1
...
# + name="all months convoluted" tags=["remove_cell"] eval=false
...
# + name="sims" tags=["remove_cell"] eval=false
