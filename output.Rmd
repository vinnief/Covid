...
graph3Dard_fia(ECDC, c('Kazakhstan','Belgium','Netherlands','Sweden'), smoothn = 1, scales = "fixed")
graph3Dard_fina(ECDC, c('Kazakhstan','Belgium','Netherlands','Sweden'), smoothn = 1,  scales = "fixed")
```
```{r}
graph3Dard_fina(ECDC, c('Kazakhstan','Belgium','Netherlands','Sweden'),  smoothn = 1, scales = "fixed")
```
