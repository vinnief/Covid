...
```
```{r}
graphit_r(JHH, regios$Vincent, xvar = 'Date', 
        yvars = c('active_imputed','recovered_imputed', 'deaths','confirmed'),
        logy = TRUE,from = "2020-01-01")
```
...
```{r NY Id In Pe}
graph3Dard_fia(JHH, c('New York,US','California,US','Florida,US','Texas,US','Peru','India'))
map_dfc(c('New York,US','California,US','Florida,US','Texas,US','Peru','India'),function(x) overtakeDays_df(JHH,x,who = 'Ithem'))
map_dfc(c('New York,US','California,US','Florida,US','Texas,US','Peru','India'),function(x) overtakeDays_df(JHH,x,who = 'theyme'))
```
