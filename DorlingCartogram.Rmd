...
Ru <-  wrld_simpl[wrld_simpl$REGION==150 & (wrld_simpl$ISO2 =="RU") & wrld_simpl$POP2005 > 0,] %>%
        spTransform(CRS("+init=epsg:3395"))
EU<- ECDC[ECDC$PSCR %in% setdiff(regios$EU, "EU") & ECDC$theDate == Sys.Date()-2, ] %>% spTransform(CRS("+init=epsg:3395"))
```
...
Ru_carto <-  cartogram_dorling(Ru, "POP2005")
```
...
plot(Afr, main="Africa Mercator")
plot(Eur, main="Europe Mercator")
plot(Am, main = "Americas Mercator")
plot(Asia, main = "Asia Mercator")
```
...
plot(Afr, main="Africa Balls size of population, distorted (sp)")
plot(Afr_carto, col = "red", add=TRUE)

plot(Eur, main="Europe  Balls size of population, distorted (sp)")
plot(Eur_carto, col = "red", add=TRUE)
```

```{r}
plot(Am, main="Americas Balls size of population, distorted (sp)")
plot(Am_carto, col = "red", add=TRUE)

plot(Asia, main="Asia  Balls size of population, distorted (sp)")
plot(Asia_carto, col = "red", add=TRUE)
```
